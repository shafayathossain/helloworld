package com.shafayat.helloworld.core.data.network
...
import com.shafayat.helloworld.utils.ConnectivityAndInternetAccess
...
object NetworkFactory {
    ...
    private const val BASE_URL = com.shafayat.helloworld.BuildConfig.BASE_URL
...
//            val token = getSharedPreference(appContext).token
    ...
    fun getLogInterceptors(): Interceptor {
        return HttpLoggingInterceptor().apply {
            level = if (com.shafayat.helloworld.BuildConfig.DEBUG) HttpLoggingInterceptor.Level.BODY
